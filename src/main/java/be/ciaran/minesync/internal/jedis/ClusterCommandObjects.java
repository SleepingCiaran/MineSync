...
import be.ciaran.minesync.internal.jedis.search.IndexOptions;
import be.ciaran.minesync.internal.jedis.search.Query;
import be.ciaran.minesync.internal.jedis.search.Schema;
import be.ciaran.minesync.internal.jedis.search.SearchResult;
